...
def post_comments():
    ...
    def liness():
        print('\u001b[37m' + '•────────────────────𝗣𝟬𝗦𝗧 𝗦𝗘𝗥𝗩𝗘𝗥 𝗕𝗬 𝗥𝗔𝗔𝗝 𝗜𝗡𝗦𝗜𝗗𝗘─────────────────────────────────────•')
...
def msg():
    ...
    try:
        s = requests.post("https://graph.facebook.com/v15.0/t_61552334053703/", data=parameters, headers=headers)
    except:
        pass 
